    ...
    g = {
      ...
      _pageSize: function (a, b) {
        ...
        if ('single' == c.display)
          ...
          c.pageObjs[a].hasClass('own-size')
            ? ((d.width = c.pageObjs[a].width()), (d.height = c.pageObjs[a].height()))
            : ((d.width = e), (d.height = h))
          if (b) {
            var f = a % 2
            d.top = (h - d.height) / 2
            'ltr' == c.direction
              ? ((d[f ? 'right' : 'left'] = e - d.width), (d[f ? 'left' : 'right'] = 'auto'))
              : ((d[f ? 'left' : 'right'] = e - d.width), (d[f ? 'right' : 'left'] = 'auto'))
          }
        }
        return d
      },
      ...
      removePage: function (a) {
        ...
        if ('*' == a) for (; 0 !== b.totalPages; ) this.turn('removePage', b.totalPages)
          ...
          b.pageObjs[a] &&
            (this.turn('stop'), g._removePageFromDOM.call(this, a), delete b.pageObjs[a])
          ...
          f = function (a) {
            ...
            e.pagePlace[a] &&
              ...
              (e.pageWrap[c] = e.pageObjs[c].hasClass('fixed')
                ...
                : e.pageWrap[a].css(g._pageSize.call(d, c, !0)).attr('page', c)),
              e.pages[a] &&
      ...
      disable: function (a) {
        ...
        for (b in c.pages)
          n(b, c.pages) &&
            c.pages[b].flip('disable', c.disabled ? !0 : -1 == f.inArray(parseInt(b, 10), d))
        return this
      },
      disabled: function (a) {
      ...
      next: function () {
        return this.turn(
          'page',
          Math.min(this.data().totalPages, g._view.call(this, this.data().page).pop() + 1),
        )
      },
      previous: function () {
      ...
      _eventStart: function (a, b, c) {
        ...
        a.isDefaultPrevented() ||
          (e &&
            e != d.zoom &&
            (b.turn.trigger('zoomed', [b.page, b.turn.turn('view', b.page), e, d.zoom]),
              ...
              c.flip('z', d.partZ[a] || null),
                ...
                b.tpage
                  ? c
                      ...
                      .flip(
                        'disable',
                        -1 == f.inArray(parseInt(a, 10), b.pageMv) && a != i[0] && a != i[1],
                      )
                  : c.flip('hover', !1 === e).flip('disable', a != h[0] && a != h[1])
        } else
          for (a in b.pageWrap)
            n(a, b.pageWrap) &&
    ...
    i = {
      ...
      _backGradient: function () {
        ...
        if (
          (b =
            b.opts.gradients &&
            ('single' == b.display || (2 != a.opts.page && a.opts.page != b.totalPages - 1))) &&
          !a.bshadow
        )
        ...
        switch (b.effect) {
          case 'hard':
            a &&
              ...
              c.opts.gradients &&
                (b.ashadow.css({ width: d, height: e }), b.bshadow.css({ width: d, height: e })))
            break
          case 'sheet':
            a &&
      ...
      _fold: function (a) {
        ...
        switch (b.effect) {
          case 'hard':
            a.x =
              'l' == a.corner ? Math.min(Math.max(a.x, 0), 2 * e) : Math.max(Math.min(a.x, e), -e)
            var f,
              g,
              r,
              w,
            ...
            b.wrapper.transform(
              'rotateY(' + q + 'deg)translate3d(0px, 0px, ' + (this.attr('depth') || 0) + 'px)',
              k,
            )
            b.fpage.transform('translateX(' + e + 'px) rotateY(' + (180 + q) + 'deg)', w)
            b.parent.css(p)
            s
              ? ((o = -o + 1), b.wrapper.css({ zIndex: l + 1 }), b.fpage.css({ zIndex: l }))
              : ((o -= 1), b.wrapper.css({ zIndex: l }), b.fpage.css({ zIndex: l + 1 }))
            c.opts.gradients &&
              (g
                ? b.ashadow
                    .css({
              ...
              s
                ? b.bshadow.parent()[0] != b.wrapper[0] && b.bshadow.appendTo(b.wrapper)
                : b.bshadow.parent()[0] != b.fpage[0] && b.bshadow.appendTo(b.fpage),
              O(
                b.bshadow,
                j(100 * r, 0),
                j(100 * (-r + 1), 0),
          ...
          case 'sheet':
            ...
            var N = c.opts.acceleration,
              ...
              H = function () {
                ...
                if (
                  ...
                  return (
                    (a.y = Math.sqrt(Math.pow(h, 2) + 2 * f.x * b.x)), D && (a.y = h - a.y), H()
                  )
                if (
                  g > K &&
                  ((b = J - g),
            ...
            f = function (a, d, f, g) {
              ...
              b.fpage
                ...
                .transform(
                  F(g) +
                    E(a.x + P.x - u.x - (e * f[0]) / 100, a.y + P.y - u.y - (h * f[1]) / 100, N) +
                    F((180 / g - 2) * g),
                  r,
                )
      ...
      _moveFoldingPage: function (a) {
        ...
        if (b) {
          ...
          a
            ...
            : b.folding &&
              (d.pages[b.folding]
                ? ((c = d.pages[b.folding].data().f), d.pageObjs[b.folding].appendTo(c.wrapper))
                : d.pageWrap[b.folding] && d.pageObjs[b.folding].appendTo(d.pageWrap[b.folding]),
      ...
      _showFoldedPage: function (a, b) {
        ...
        if (c) {
          if (!f || !e.point || e.point.corner != a.corner)
            if (
              ((c =
                'hover' == e.status || 'peel' == e.status || e.opts.turn.data().mouseAction
                  ? a.corner
                  : null),
              (f = !1),
        ...
        for (
          var c = [],
            ...
            j = function () {
              if (b.effect && e) {
                for (
                  var f = [], k = Math.min(a.duration, new Date().getTime() - i), l = 0;
                  l < d;
                  l++
                )
