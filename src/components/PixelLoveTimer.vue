...
data() {
    return {
    targetDate: new Date('2025-05-25T00:00:00'),
    days: 0,
    hours: 0,
    minutes: 0,
    seconds: 0,
...
methods: {
    updateTimer() {
    const now = new Date();
    // Untuk tanggal di masa depan, kita hitung berapa lama hingga tanggal tersebut
    ...
    if (timeDifference > 0) {
        ...
        // Jika tanggal target sudah tercapai
        this.days = "00";
        this.hours = "00";
        this.minutes = "00";
        this.seconds = "00";
        this.message = "Our special day has arrived! ❤️";
        this.isSpecialDay = true; // Mengaktifkan link
    }
    },
    formatTime(time) {
...
box-shadow: 0 0 0 4px white, 0 0 0 12px #ff69b4;
padding: 30px;
border-radius: 10px;
width: 90%;
max-width: 800px;
...
.heart5 { left: 90%; animation-delay: 3s; }
